from sqlalchemy import (
    ...
    DateTime,
    VARCHAR,
    func, Boolean, BigInteger, UniqueConstraint, Index, )
...
class Websocket(Base):
    ...
    __table_args__ = (
        Index('ix_username_browser', "username", "w_browser"),  # 非唯一的联合索引
    )
    ...
    w_browser = Column(VARCHAR(32), nullable=False, comment='(useragent+username)的hash256')
